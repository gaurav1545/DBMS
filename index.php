...
<div class="w3-top">
  <div class="w3-bar" id="myNavbar">
    ...
    <a href="#contact" class="w3-bar-item w3-button w3-hide-small"><i class="fa fa-envelope"></i> CONTACT</a>
		<a href="#register" class="w3-bar-item w3-button w3-hide-small"><i class="fa fa-envelope"></i> REGISTER</a>
...
<div class="w3-content w3-container w3-padding-64" id="about">
  ...
  <p class="w3-center"><em>Quality is job one. Service standards keep rising.</em></p>
  <p>No matter what you’re looking for in a gym, we’ve got a membership option made for you. All NITFIT members enjoy unlimited access to their home club and the support of our friendly, knowledgeable staff anytime you need it. NF Black Card® members receive additional benefits, including the ability to bring a guest for free and access to any of our 1,700+ NF locations.
Looking for a little extra guidance or inspiration to help you meet your fitness goals? As a NF member, you can take advantage of our free fitness training or find your motivation by reading real member experiences on Planet of Triumphs.
It’s our goal to provide a clean, safe, welcoming environment for anyone who walks through our door, and all the equipment, amenities and support you need once you’re here.</p>
  <div class="w3-row">
    <div class="w3-col m6 w3-center w3-padding-large">
      <img src="GymImg/basicgym.jpg" class="w3-round w3-image w3-opacity w3-hover-opacity-off" alt="Photo of Me" width="500" height="333">
		</div>

    <!-- Hide this text on small devices -->
    <div class="w3-col m6 w3-hide-small w3-padding-large">
      <p>Welcome To Nitfit.NitFit was founded in 1982, in Chrome,NY . In the beginning, it operated much like every other gym in its small hometown and catered to the same small percentage of the population in the U.S. who worked out and belonged to a health club.

NF’s owners quickly recognized that there was a greater opportunity to serve a much larger segment of the population. They asked themselves, “Why does 80-85% of the population not belong to a gym?” The answer? First-time and casual gym users didn’t like the “look at me” attitudes and behaviors found in typical gyms, and they didn’t want to have to pay a lot of money to give fitness a try.</p>
    </div>
  </div>
  <p class="w3-large w3-center w3-padding-16">This year we have</p>
  <p class="w3-wide"><i class="fa fa-camera"></i><b>New Customers</b></p>
  <div class="w3-light-grey">
    <div class="w3-container w3-padding-small w3-dark-grey w3-center" style="width:90%">90%</div>
  </div>
  <p class="w3-wide"><i class="fa fa-laptop"></i><b>New Equipment</b></p>
  <div class="w3-light-grey">
    <div class="w3-container w3-padding-small w3-dark-grey w3-center" style="width:85%">85%</div>
  </div>
  <p class="w3-wide"><i class="fa fa-photo"></i><b>New Branches Opened</b></p>
  <div class="w3-light-grey">
...
<footer class="w3-center w3-black w3-padding-64 w3-opacity w3-hover-opacity-off">
  ...
  <p>Powered by <a href="https://www.w3schools.com/w3css/default.asp" title="GAURAV.CSS" target="_blank" class="w3-hover-text-green">w3.css</a></p>
</footer>
...
<form>
<input type="button" value="Put Your Text Here" onclick="welcome.php" />
</form>
